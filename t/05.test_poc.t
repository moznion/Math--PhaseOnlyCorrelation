...
subtest 'Correlation same signal' => sub {
    ...
    is_deeply ($got, [1, 0, -3.92523114670944e-17, 0, 5.55111512312578e-17, 0, 3.92523114670944e-17, 0, 0, 0,
                      3.92523114670944e-17, 0, 5.55111512312578e-17,0, -3.92523114670944e-17,0]);
};

subtest 'Correlation different signal' => sub {
    $array2 = [1,-2,3,-4,5,-6,7,-8];
    $got = Statistics::PhaseOnlyCorrelation->poc($array1, $array2);
    is_deeply ($got, [-0.25, 0, 0.603553390593274, 0, -0.25, 0, 0.103553390593274, 0, -0.25, 0,
                      -0.103553390593274, -0, -0.25, 0, -0.603553390593274, 0]);
};
